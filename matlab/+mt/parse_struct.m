function params = parse_struct(params, args)

%   PARSE_STRUCT -- Assign variable inputs to struct.
%
%     params = mt.parse_struct( S, ARGS ) where ARGS is a cell array of
...
%
%     s1 = mt.parse_struct( s, {'hello', 11} );
%     s2 = mt.parse_struct( s, {struct('hello', 11)} );
%     s3 = mt.parse_struct( s, {{'hello', 11}, struct('hi', 11)} );

validateattributes( params, {'struct'}, {'scalar'}, mfilename, 'params' );
validateattributes( args, {'cell'}, {}, mfilename, 'args' );
